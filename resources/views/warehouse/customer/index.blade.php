...
@section('content')
            {{-- Admin login see customers for transactions (orders) --}}
<div class="container" >
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet light ">
				<div class="portlet-title" >
					<div class="caption">
						...
						<span class="caption-subject font-red sbold uppercase"><b>Customer List </b></span><br>
                        <span class="font-red">Select Customer To See Their Transactions</span>
					</div>
					<div class="actions">
						...
						<div class="table-scrollable">
							<table class="table table-hover table-light " id="myTable">
                                ...
                                <tbody >
                                   @foreach($customers as $key => $customer)
                                   <tr>
                                    <td><span class="label label-sm" style="font-size: 25px"><a href="{{ route('head.show',encrypt($customer->id)) }}">{{ $customer->name }}</a></span>
                                    </td>
                                    <td class="uppercase" style="font-size: 17px">{{ $customer->email }}</td>
                            ...
                            <form  class="form-horizontal" style="padding: 20px;" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group{{$errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="form-group">
                                            <label for="quantity" class="col-md-4 control-label"><strong>Email</strong></label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="contact_no" class="col-md-4 control-label"><strong>Contact</strong></label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                            <label for="address" class="col-md-4 control-label"><strong>Address</strong></label>
                                            <div class="col-md-6">
