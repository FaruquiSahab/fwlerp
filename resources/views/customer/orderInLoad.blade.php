...
<div class="container" >
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet light ">
				<div class="portlet-title" >
					<div class="caption">
						...
						<span class="caption-subject font-red sbold uppercase"><b>Present Inventory Position</b></span>
					</div>
					<div class="actions">
						<div class="btn-group btn-group-devided" data-toggle="buttons">
                            ...
                            {{-- Ye Kaam 1 --}}
							{{-- <a href=""  data-target="#addmodel" data-toggle="modal" class="btn btn-circle btn btn-transparent purple btn-outline  btn-sm active" >Request Inload</a> --}}
                            {{-- 1  --}}
						</div>
					</div>
								...
								<thead>
                                    ...
                                    <tbody >
                                     ...
                                     <tr>
                                        ...
                                        <td>{{ trim($order->created_at->diffForHumans(),'ago') }}</td>                                    
                                        <td>
                                        ...
                                        <td>
                                            <form method="POST" action="{{ route('cust.inOne') }}">
                                                {{ csrf_field() }}
            ...
            <form method="GET" action="{{ route('cust.inAll') }}">
                        ...
                        <div class="modal-body" > 
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('order_inload.store') }}" >
                                ...
                                <div class="form-group{{$errors->has('product_id') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        {!! Form::select('product_id', $product , null, ['placeholder' => 'Select a Product...', 'class'=>'form-control', 'name'=>'product_id','id'=>'productSelect'])!!}
...
<div class="col-md-12">
            ...
            <div class="portlet light ">
                <div class="portlet-title" >
                    <div class="caption">
                        <i class="icon-settings font-red"></i>
                        <span class="caption-subject font-red sbold uppercase"><b>Last Dispatch Orders</b></span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided" data-toggle="buttons">

                            {{-- <a href=""  data-target="#addmodel1" data-toggle="modal" class="btn btn-circle btn btn-transparent purple btn-outline  btn-sm active" >Request Offload</a> --}}
                            ...
                            <table class="table table-hover table-light" id="myTable1">
                                ...
                                <tbody >
                                 ...
                                 <tr>
                                    ...
                                    <td> 
                                        <a class="label label-sm label-danger againstGrn" style="font-size: 18px">
                                            {{ $order->inload->grn }}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    @endif
                                    <td>
                                        <form method="POST" action="{{ route('cust.offOne') }}">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="id" value="{{ encrypt($order->id) }}">
                                            <button class="btn btn-md blue hidden-print margin-bottom-5">Print</button>
                                        </form>
            ...
            <form method="GET" action="{{ route('cust.offAll') }}">
                <input type="hidden" name="customer_id" value="{{ Auth::guard('customers')->user()->id }}">
                <button class="btn btn-lg blue hidden-print" >Print</button>
            </form>
                ...
                <div class="modal fade in" id="addmodel1" tabindex="-1" role="basic" aria-hidden="true" style=" padding-right: 16px;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                <h4 class="modal-title">Request Offload</h4>
                            </div>
                            <div class="modal-body" > 
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('order_offload.store') }}" >
                                    ...
                                    <div class="form-group{{$errors->has('inload_id') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            {!! Form::select('inload_id', $inload , null, ['placeholder' => 'Select a Order...', 'class'=>'form-control', 'name'=>'inload_id', 'id'=>'orderSelect' ])!!}
